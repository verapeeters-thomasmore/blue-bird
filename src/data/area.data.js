...
export const GARDEN_WHITE = {
    ...
    areas: [
        ...
        {id: getNextAreaId(), "x": 0, "z": 0, "plantName": "anthericum_liliago"},
        {id: getNextAreaId(), "x": 3, "z": 3, "plantName": "anthericum_liliago"},
...
const GARDEN_A_LITTLE_BIT_OF_ORANGE = {
    ...
    areas: [
        ...
        {id: getNextAreaId(), "x": -1, "z": 3, "plantName": "stipa"},
        {id: getNextAreaId(), "x": 1, "z": 4, "plantName": "echinacea_purpurea_polar_breeze"},
        {id: getNextAreaId(), "x": -30, "z": 1, "plantName": "echinacea_purpurea_polar_breeze"},
        {id: getNextAreaId(), "x": -.93, "z": 3, "plantName": "stipa"},
        {id: getNextAreaId(), "x": 2, "z": 21, "plantName": "stipa"},
        {id: getNextAreaId(), "x": -3, "z": -2, "plantName": "sporobolus"},
        {id: getNextAreaId(), "x": 4, "z": .97, "plantName": "sporobolus"},
        {id: getNextAreaId(), "x": -4, "z": -4, "plantName": "sporobolus"},
        {id: getNextAreaId(), "x": 4, "z": -3, "plantName": "sporobolus"}
    ],
}
export const GARDEN_AUTUMN = {
    ...
    areas: [
        ...
        {id: getNextAreaId(), "x": 4, "z": 3, "plantName": "stipa"},
        {id: getNextAreaId(), "x": -20, "z": 2, "plantName": "stipa"},
        {id: getNextAreaId(), "x": -3, "z": 4, "plantName": "stipa"},
        {id: getNextAreaId(), "x": 20, "z": 3, "plantName": "echinacea_purpurea_polar_breeze"},
        {id: getNextAreaId(), "x": -4, "z": 3, "plantName": "echinacea_purpurea_polar_breeze"},
        ...
        {id: getNextAreaId(), "x": -.63, "z": -.54, "plantName": "deschampsia"},
        {id: getNextAreaId(), "x": 3, "z": .33, "plantName": "calamagrostis"},
        {id: getNextAreaId(), "x": -20, "z": -0, "plantName": "calamagrostis"},
        {id: getNextAreaId(), "x": .32, "z": 3, "plantName": "aster"},
        {id: getNextAreaId(), "x": -30, "z": 2, "plantName": "aster"},
        {id: getNextAreaId(), "x": 4, "z": 3, "plantName": "aster"},
        {id: getNextAreaId(), "x": 3, "z": 3, "plantName": "aster"},
        {id: getNextAreaId(), "x": .29, "z": 2, "plantName": "aster"},
        {id: getNextAreaId(), "x": -2, "z": -2, "plantName": "sporobolus"},
        {id: getNextAreaId(), "x": 3, "z": -3, "plantName": "sporobolus"},
        {id: getNextAreaId(), "x": -4, "z": 3, "plantName": "aster"},
        {id: getNextAreaId(), "x": -3, "z": 3, "plantName": "anthericum_liliago"},
        {id: getNextAreaId(), "x": 20, "z": 3, "plantName": "anthericum_liliago"},
        {id: getNextAreaId(), "x": -2, "z": 3, "plantName": "anthericum_liliago"},
        {id: getNextAreaId(), "x": -3, "z": 2, "plantName": "lillium_regale"},
        {id: getNextAreaId(), "x": 3, "z": .74, "plantName": "lillium_regale"},
        {id: getNextAreaId(), "x": 4, "z": -.08, "plantName": "sporobolus"},
        {id: getNextAreaId(), "x": -20, "z": -30, "plantName": "sporobolus"}
    ]
}
